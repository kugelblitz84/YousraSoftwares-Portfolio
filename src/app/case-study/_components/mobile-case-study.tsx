        ...
        <header className="overflow-hidden border-b border-zinc-200 bg-zinc-50 pt-36 sm:pt-44 dark:border-zinc-800 dark:bg-zinc-950 dark:text-white">
          <div className="shell pb-16 sm:pb-20">
            ...
            <div className="mt-10 grid items-end gap-8 lg:grid-cols-[.85fr_1.15fr]">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl shadow-zinc-900/15 sm:rounded-3xl dark:border-white/10 dark:bg-zinc-900 dark:shadow-black/40">
                <Image
                  src={project.cover}
                  width={1920}
                  height={1080}
