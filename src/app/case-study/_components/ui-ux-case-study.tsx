        ...
        <header className="soft-grid section-pad pt-36 sm:pt-44">
          <div className="shell text-center">
            ...
            <div className="mt-12 rounded-[2rem] border border-zinc-200 bg-white/80 p-3 shadow-2xl shadow-sky-500/10 sm:p-6 dark:border-zinc-800 dark:bg-zinc-900/80">
              <Image src={project.cover} width={1200} height={760} className="w-full rounded-2xl" alt={`Placeholder for the ${project.name} presentation`} preload />
            </div>
          </div>
        </header>
            ...
            <div className="shell">
              ...
              <div className="mt-10 grid gap-5 sm:grid-cols-2">
                {project.gallery.map((src, index) => (
                  <Image key={index} src={src} width={1200} height={760} className="rounded-2xl" alt={`${project.name} frame placeholder ${index + 1}`} />
                ))}
              </div>
            </div>
          </section>
