  ...
  return (
    <main id="main">
      <article>
        <header className="soft-grid section-pad pt-36 sm:pt-44">
          <div className="shell text-center">
            <Link href="/projects/ui-ux" className="group inline-flex items-center gap-1.5 text-sm font-medium text-accent">
              <RiArrowLeftLine
            ...
            <SplitTextReveal
              as="p"
              text="[A concise summary of the user problem, the experience redesigned, and the intended product outcome.]"
            ...
            <div className="mt-12 rounded-[2rem] border border-zinc-200 bg-white/80 p-3 shadow-2xl shadow-sky-500/10 sm:p-6 dark:border-zinc-800 dark:bg-zinc-900/80">
              <Image src="/assets/projects/project-placeholder.svg" width={1200} height={760} className="w-full rounded-2xl" alt="Placeholder for the UI/UX project presentation" preload />
            </div>
          </div>
        </header>
      ...
      <section className="section-pad text-center">
        ...
        />
        <Link href="/#contact" className="group btn-primary mt-7 inline-flex items-center rounded-full px-7 py-3.5 text-white"><TextHoverRoll text="Start a design project" />
          <RiArrowRightLine
